...
class ListaPacientesFragment : Fragment(), LoaderManager.LoaderCallbacks<Cursor> {
    ...
    private var adapterLivros: AdapterPacientes? = null
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        val recyclerViewLivros = view.findViewById<RecyclerView>(R.id.RecyclerViewPacientes)
        adapterLivros = AdapterPacientes(this)
...
//            findNavController().navigate(R.id.action_FirstFragment_to_SecondFragment)
    ...
    override fun onCreateLoader(id: Int, args: Bundle?): Loader<Cursor> {
        return CursorLoader(
            requireContext(),
            ContentProviderPacientes.ENDERECO_LIVROS,
            TabelaPacientes.TODAS_COLUNAS,
            null, null,
            TabelaPacientes.CAMPO_TITULO
        )
    }
