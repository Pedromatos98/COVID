...
class AdapterInfetados (val fragment: ListaInfetadosFragment) : RecyclerView.Adapter<AdapterInfetados.ViewHolderInfetado>(){
     ...
     */
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolderInfetado {
        val itemInfetado = fragment.layoutInflater.inflate(R.layout.item_infetado, parent, false)

        return ViewHolderInfetado(itemInfetado)
    }
     ...
     */
    override fun onBindViewHolder(holder: ViewHolderInfetado, position: Int) {
        cursor!!.moveToPosition(position)
        holder.atualizaInfetado(Infetado.fromCursor(cursor!!))
    }
